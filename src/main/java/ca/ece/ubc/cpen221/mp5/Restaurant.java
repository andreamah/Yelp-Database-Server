...
public class Restaurant extends Business{
	...
	public Restaurant(boolean open, String url, double lattitude, double longitude, String[] neighborhoods,
			String business_id, String name, String[] categories, String state, String type, String city,
			String full_address, double stars, int review_count,String photo_url,String[] schools ) {
		super(open, url, lattitude, longitude, neighborhoods, business_id, name, categories, state, type, city, full_address);
		this.stars = stars;
